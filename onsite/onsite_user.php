...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $request_type = "OnSite Call"; // Set request type to "Incoming Repair"
    ...
    <div class='mail-container'>
        ...
        <div class='mail-content'>
            ...
            <div class='address-section'>
                <p><strong>On-site Address:</strong></p>
                <p>Address: $address</p>
                <p>City: $city</p>
        ...
        <div class='mail-footer'>
          ...
          $bindResult = $stmt->bind_param(
            ...
            if ($executeResult) {
                ...
                $stmt->close();
                $conn->close();
                header("Location: onsite_user.php");
                exit();
            } else {
...
<div id="onsiteCallNote" style="margin-top: 15px; background-color: #f0f8ff; padding: 20px; border-radius: 5px; margin-bottom: 30px; text-align: center;">
  ...
  <p><strong>Phone:</strong> (614) 306-9986</p>
    ...
    <form id="requestForm" action="onsite_user.php" method="post" data-aos="fade-up">
      <?php if(!isset($_SESSION['userid']) || empty($userData)): ?>
      ...
      <div class="form-group" style="text-align: center;">
        <button type="submit" class="modern-button">Send Email</button>
      </div>
    </form>
