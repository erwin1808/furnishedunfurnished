...
<style>
  ...
  .place-card.selected {
    border-color: black; /* charcoal when selected */
    ...
    <div class="col-md-10">
      <div class="row g-4 justify-content-center">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card place-card border border-2 rounded-3 p-3" data-value="House">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card place-card border border-2 rounded-3 p-3" data-value="Apartment">
            <div class="card-body d-flex flex-column align-items-center">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="card place-card border border-2 rounded-3 p-3" data-value="Barn">
            <div class="card-body d-flex flex-column align-items-center">
              <i class="fas fa-warehouse fa-2x mb-3 text-primary"></i>
              <h6 class="mb-0">Barn</h6>
            </div>
          </div>
        </div>
